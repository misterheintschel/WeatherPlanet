      ...
      return (
        ...
        <div className="Card" key={index} style={{backgroundImage: `url(${this.props.iconPath.find(o => o.key === element.weather[0].icon).value})`,
          ...
          <div className="ForecastValues">
            ...
            <p id="maxTempF"><img id="maxTempArrow" src={this.findImage('thermoRed')}/> {Math.round(element.temp.max)}&deg;</p>
            <p id="minTempF"><img id="minTempArrow" src={this.findImage('thermoBlue')}/> {Math.round(element.temp.min)}&deg;</p>
